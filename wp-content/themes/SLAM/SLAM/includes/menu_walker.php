...
// thanks to https://gist.github.com/1597994
// revisited by me, it had some issues
...
if ( !function_exists( 'bootstrap_setup' ) ):
...

	{
...

		{
			...
			//$args = (object) $args;
			function start_el( &$output, $item, $depth = 0, $args = object, $id = 0 )
...

			{
				...
				} //( $max_depth == 0 || $max_depth > $depth + 1 ) && isset( $children_elements[ $id ] )
