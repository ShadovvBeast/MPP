...
function get_pb_parser($gt3_modules)
{
    global $gt3_lineWidth; $compile = "";
    if (!is_array($gt3_modules)) {$gt3_modules=array();}
    $allModulesCount = count($gt3_modules);
    $normalModulesCount = 0;
    $allModulesICounter = 0;
    $normalModulesICounter = 0;

    #Count normal modules
    foreach ($gt3_modules as $module_key => $module) {
    ...
    foreach ($gt3_modules as $module_key => $module) {
        ...
        if ($module['name']=="bg_start" || $module['name']=="bg_end") {
            ...
            if ($normalModulesICounter == 1 || $gt3_lineWidth >= 1) {
                $gt3_lineWidth = 0;
