...
/* PB MODULES */
$gt3_modules['accordion']['name'] = "accordion";
$gt3_modules['accordion']['caption'] = "Accordion";
$gt3_modules['accordion']['help'] = __("Add simple accordion style with collapsible components.", "gt3_builder");

$gt3_modules['before_after']['name'] = "before_after";
$gt3_modules['before_after']['caption'] = "Before/After";
$gt3_modules['before_after']['help'] = __("Demonstrate photo before and after processing", "gt3_builder");

$gt3_modules['blog']['name'] = "blog";
$gt3_modules['blog']['caption'] = "Blog";
$gt3_modules['blog']['help'] = __("Display standard style blog to the page.", "gt3_builder");

$gt3_modules['feature_posts']['name'] = "feature_posts";
$gt3_modules['feature_posts']['caption'] = "Blog Posts";
$gt3_modules['feature_posts']['help'] = __("Display blog posts from different categories.", "gt3_builder");

/*$gt3_modules['blog_masonry']['name'] = "blog_masonry";
$gt3_modules['blog_masonry']['caption'] = "Blog - Masonry";
$gt3_modules['blog_masonry']['help'] = __("Display masonry style blog to the page.", "gt3_builder");*/

$gt3_modules['content']['name'] = "content";
$gt3_modules['content']['caption'] = "Content";
$gt3_modules['content']['help'] = __("Display entire content available in the visual editor.", "gt3_builder");

$gt3_modules['counter']['name'] = "counter";
$gt3_modules['counter']['caption'] = "Counter";
$gt3_modules['counter']['help'] = __("Add advanced counter block with icon.", "gt3_builder");

$gt3_modules['divider']['name'] = "divider";
$gt3_modules['divider']['caption'] = "Divider";
$gt3_modules['divider']['help'] = __("Add divider to separate module blocks.", "gt3_builder");

/*$gt3_modules['faq']['name'] = "faq";
$gt3_modules['faq']['caption'] = "FAQ";
$gt3_modules['faq']['help'] = __("Add FAQ module blocks.", "gt3_builder");*/

$gt3_modules['gallery']['name'] = "gallery";
$gt3_modules['gallery']['caption'] = "Gallery";
$gt3_modules['gallery']['help'] = __("Display gallery from existing gallery list.", "gt3_builder");

$gt3_modules['google_map']['name'] = "google_map";
$gt3_modules['google_map']['caption'] = "Google Map";
$gt3_modules['google_map']['help'] = __("Add simple google map.", "gt3_builder");

$gt3_modules['html']['name'] = "html";
$gt3_modules['html']['caption'] = "HTML";
$gt3_modules['html']['help'] = __("Add any HTML code or shortcode to display on the page.", "gt3_builder");

$gt3_modules['title']['name'] = "title";
$gt3_modules['title']['caption'] = "Heading";
$gt3_modules['title']['help'] = __("Add simple heading.", "gt3_builder");

$gt3_modules['iconboxes']['name'] = "iconboxes";
$gt3_modules['iconboxes']['caption'] = "Icon Box";
$gt3_modules['iconboxes']['help'] = __("Add content block with the icon.", "gt3_builder");

$gt3_modules['contact_info']['name'] = "contact_info";
$gt3_modules['contact_info']['caption'] = "Icon List";
$gt3_modules['contact_info']['help'] = __("Add icon list with the text link option.", "gt3_builder");

$gt3_modules['javascript']['name'] = "javascript";
$gt3_modules['javascript']['caption'] = "Javascript";
$gt3_modules['javascript']['help'] = __("Add javascript code to run on the page.", "gt3_builder");

$gt3_modules['messageboxes']['name'] = "messageboxes";
$gt3_modules['messageboxes']['caption'] = "Message Box";
$gt3_modules['messageboxes']['help'] = __("Add different message box types.", "gt3_builder");

$gt3_modules['partners']['name'] = "partners";
$gt3_modules['partners']['caption'] = "Partners";
$gt3_modules['partners']['help'] = __("Display the partners logos from existing list.", "gt3_builder");

$gt3_modules['portfolio']['name'] = "portfolio";
$gt3_modules['portfolio']['caption'] = "Portfolio";
$gt3_modules['portfolio']['help'] = __("Add non-ajax portfolio to the page.", "gt3_builder");

/*$gt3_modules['portfolio_masonry']['name'] = "portfolio_masonry";
$gt3_modules['portfolio_masonry']['caption'] = "Portfolio Masonry";
$gt3_modules['portfolio_masonry']['help'] = __("Add non-ajax portfolio to the page.", "gt3_builder");*/

$gt3_modules['feature_portfolio']['name'] = "feature_portfolio";
$gt3_modules['feature_portfolio']['caption'] = "Portfolio Posts";
$gt3_modules['feature_portfolio']['help'] = __("Display portfolio posts from different categories.", "gt3_builder");

$gt3_modules['price_table']['name'] = "price_table";
$gt3_modules['price_table']['caption'] = "Price Table";
$gt3_modules['price_table']['help'] = __("Add simple and advanced price table.", "gt3_builder");

$gt3_modules['diagramm']['name'] = "diagramm";
$gt3_modules['diagramm']['caption'] = "Progress Bar";
$gt3_modules['diagramm']['help'] = __("Add advanced and flexible progress bar.", "gt3_builder");

$gt3_modules['promo_text']['name'] = "promo_text";
$gt3_modules['promo_text']['caption'] = "Promo Text";
$gt3_modules['promo_text']['help'] = __("Add special promo text with call to action button.", "gt3_builder");

$gt3_modules['sitemap']['name'] = "sitemap";
$gt3_modules['sitemap']['caption'] = "Sitemap";
$gt3_modules['sitemap']['help'] = __("Add simple sitemap.", "gt3_builder");

$gt3_modules['slider']['name'] = "layer_slider";
$gt3_modules['slider']['caption'] = "Slider";
$gt3_modules['slider']['help'] = __("Add any slider plugin that uses shortcodes.", "gt3_builder");

$gt3_modules['tabs']['name'] = "tabs";
$gt3_modules['tabs']['caption'] = "Tabs";
$gt3_modules['tabs']['help'] = __("Add tabbed content area.", "gt3_builder");

$gt3_modules['team']['name'] = "team";
$gt3_modules['team']['caption'] = "Team";
$gt3_modules['team']['help'] = __("Display selected team members from existing list.", "gt3_builder");

$gt3_modules['testimonial']['name'] = "testimonial";
$gt3_modules['testimonial']['caption'] = "Testimonials";
$gt3_modules['testimonial']['help'] = __("Display the selected testimonials from existing list.", "gt3_builder");

$gt3_modules['text_area']['name'] = "text_area";
$gt3_modules['text_area']['caption'] = "Text Area";
$gt3_modules['text_area']['help'] = __("Add simple text area.", "gt3_builder");

$gt3_modules['toggle']['name'] = "toggle";
$gt3_modules['toggle']['caption'] = "Toggle";
$gt3_modules['toggle']['help'] = __("Add simple toggle style with collapsible components.", "gt3_builder");

$gt3_modules['video']['name'] = "video";
$gt3_modules['video']['caption'] = "Video";
$gt3_modules['video']['help'] = __("Add vimeo or youtube video.", "gt3_builder");
/* END PB MODULES */
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont diagram_admin'>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Background', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_bg]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg'] : '3a3a3a')) . "</div>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Color', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_color]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color'] : '00d8ff')) . "</div>
		...
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Bar Size:', 'gt3_builder'), "diagram_size", "95px", "left", "65px") . "</div>
