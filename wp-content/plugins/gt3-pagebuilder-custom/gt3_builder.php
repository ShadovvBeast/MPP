<?php
/*
Plugin Name: GT3 Page Builder (For Diamond Theme Only)
...
#GALLERY AREA
    if ($now_post_type == "gallery") {
        ...
        <!-- FULLSCREEN SLIDER SETTINGS -->
            ...
            echo "<div class='padding-cont'>
									<div>
										<div class='fs_fit_select'><h2>" . __('Show Thumbs:', 'gt3_builder') . "</h2><select name='pagebuilder[sliders][fullscreen][thumbs]' class='strip_select'>";
            $fs_fit_style = array("yes" => "Yes", "no" => "No");
            foreach ($fs_fit_style as $var_data => $var_caption) {
                echo "<option " . ((isset($gt3_theme_pagebuilder['sliders']['fullscreen']['thumbs']) && $gt3_theme_pagebuilder['sliders']['fullscreen']['thumbs'] == $var_data) ? 'selected="selected"' : '') . " value='" . $var_data . "'>" . $var_caption . "</option>";
            }
            echo '</select></div><br />
			';
...
#FS PORTFOLIO
    if ($now_post_type == "page" && (get_page_template_slug() == "page-portfolio-masonry.php" || get_page_template_slug() == "page-portfolio-masonry-block.php"|| get_page_template_slug() == "page-portfolio-grid-block.php"|| get_page_template_slug() == "page-portfolio-grid.php")) {
    ...
    if ($now_post_type == "page" && get_page_template_slug() == "page-fullscreen-slider.php") {
        ...
        <!-- FULLSCREEN SLIDER SETTINGS -->
            ...
            echo "<div style='width: 190px;' class='caption'><h2 style='color:#A1A1A1;' class='text-shadow2'>" . __('Show Controls:', 'gt3_builder') . "</h2></div>
										...
										<div class='clear'></div>
<br />
<div style='width: 190px;' class='caption'><h2 style='color:#A1A1A1;' class='text-shadow2'>" . __('Show Thumbs:', 'gt3_builder') . "</h2></div>
										<div class='radio_selector'>
											" . toggle_radio_on_off('pagebuilder[sliders][fullscreen][thumbs]', (isset($gt3_theme_pagebuilder['sliders']['fullscreen']['thumbs']) ? $gt3_theme_pagebuilder['sliders']['fullscreen']['thumbs'] : ''), 'on') . "
										</div><br style='clear:both'>
										<div class='clear'></div>
<br />
